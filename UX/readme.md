...
## 4 Lista métodos UX DIU Toolkit 

A continuación se muestran los métodos seleccionados para la creación del  **UX-DIU-Checklist** toolkit, la herramienta que se usa en las asignatura de Diseño de Interfaces de Usuario de la Universidad de Granada  https://mgea.github.io/UX-DIU-Checklist/index.html
...
* **Moodboard.** It helps designers and stakeholders get on the same page for the visual aspects of the project. In UX Design and product design, a mood board is a collage of images, fonts, interactions, features, icons, and UI elements to communicate the artistic direction of a project.
  ...
  Design Mood. 7 Motives to Create Mood Boards (UX planet 2017) https://uxplanet.org/design-mood-7-motives-to-create-mood-boards-b81ae36e399f
...
Esta herramienta Web tiene como objetivo ayudar al diseñador para elegir el método adecuado. Además, al estar en repositorio Github, se facilita la reutilización y adaptación para otros usuarios y que puedan extender  y/o modificar los metodos. De hecho, es una adaptación de Soverini (Soverini, 2018). 

Además, hay un par de herramientas de ayuda para generar en modo online el diseño de Personas y User Journey Map (https://mgea.github.io/UX-DIU-Toolkit/index.html). La idea sería que en el futuro haya más herramientas Open Source para realizar todas esos métodos.  



![image-20220912104205782](/Users/mgea/Library/Application Support/typora-user-images/image-20220912104205782.png)
...
* Andrea Soverini (2018) **UX Project Checklist** (disponible en Github) https://uxchecklist.github.io/   

  Explicación del proceso de selección: https://medium.com/uxchecklist/ux-project-checklist-why-i-made-it-and-whats-next-6df312b0b92e 
